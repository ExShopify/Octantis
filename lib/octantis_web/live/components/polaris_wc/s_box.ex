defmodule OctantisWeb.Components.PolarisWC.SBox do
  @moduledoc """
  ...
  See
    - http://shopify.dev/docs/api/app-home/polaris-web-components/structure/box
  """
  ...
  s_attr :background, :background_color,
    doc: """
      Adjust the background of the element.
    """

  s_attr :block_size, :size_units_or_auto,
    doc: """
      "auto" | SizeUnits
  ...
  s_attr :display, {:responsive, ["auto", "none"]},
    doc: """
  ...
  s_attr :inline_size, :size_units_or_auto,
    doc: """
  ...
  s_attr :min_block_size, :size_units,
    doc: """
      Adjust the minimum block size.
    """

  s_attr :min_inline_size, :size_units,
    doc: """
      Adjust the minimum inline size.
    """

  s_attr :overflow, :overflow,
    doc: """
  ...
  def s_box(assigns) do
    assigns = assigns |> assign_s_attrs()

    ~H"""
    <s-box {@s_attrs} {@rest}>{render_slot(@inner_block)}</s-box>
    """
  end
end
