defmodule OctantisWeb.Components.Polaris do
  ...
  defdelegate s_select(assigns), to: OctantisWeb.Components.PolarisWC.SSelect
  defdelegate s_spinner(assigns), to: OctantisWeb.Components.PolarisWC.SSpinner
  ...
  defdelegate s_unordered_list(assigns), to: OctantisWeb.Components.PolarisWC.SUnorderedList
end
